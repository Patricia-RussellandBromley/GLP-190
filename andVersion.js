(function v1() {
    ...
    */
    ...
    const main_190 = () => {
        ...
        if (isHomePage()) {
            ...
            waitUntil(() => {
                ...
                return document.querySelectorAll("div#main > div.row").length > 0
            }).then(() => {
    ...
    waitUntil(() => {
        ...
        return document.querySelectorAll("div#main > div.row").length > 0 && typeof window.jQuery === "function";

    }).then(() => {

        optiReady('div#main .row:first-child .redBox a.top-banner-wrapper', () => {
            depuration("enter observer");
...
//document.cookie = 'R&B_GLP_QA=true';